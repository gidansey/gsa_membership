...
header('Content-Disposition: attachment; filename=event_participation_export.csv');
...
// Query event participation records
$sql = "
    SELECT 
...
if ($result && $result->num_rows > 0) {
    ...
    fputcsv($output, ['No event participation data found.']);
}
